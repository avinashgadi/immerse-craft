...
-- Insert sample destinations (150+ destinations)
...
-- Asia - Updated with specific destination images
('Mount Fuji', 'Iconic mountain in Japan with stunning views and traditional pagoda', 'Japan', 'Asia', 'Nature', '/src/assets/dest-mount-fuji.jpg', 39.99, 50, 4.9, 35.3606, 138.7274, true),
('Taj Mahal', 'Ivory-white marble mausoleum and symbol of eternal love', 'India', 'Asia', 'Cultural', '/src/assets/dest-taj-mahal.jpg', 27.99, 40, 4.9, 27.1751, 78.0421, true),
('Angkor Wat', 'Ancient temple complex in Cambodia with magnificent architecture', 'Cambodia', 'Asia', 'Cultural', '/src/assets/dest-angkor-wat.jpg', 29.99, 45, 4.9, 13.4125, 103.8670, true),
('Great Wall of China', 'Historic fortification stretching across mountains in China', 'China', 'Asia', 'Cultural', '/src/assets/dest-great-wall.jpg', 32.99, 55, 4.8, 40.4319, 116.5704, true),
('Tokyo Shibuya', 'Bustling urban district with neon lights and vibrant nightlife', 'Japan', 'Asia', 'Urban', '/src/assets/dest-tokyo-shibuya.jpg', 34.99, 60, 4.8, 35.6598, 139.7006, true),
('Petra', 'Archaeological city carved into red sandstone cliffs in Jordan', 'Jordan', 'Asia', 'Cultural', '/src/assets/dest-petra.jpg', 35.99, 65, 4.8, 30.3285, 35.4444, true),
('Borobudur', 'Buddhist temple complex with intricate stone carvings in Indonesia', 'Indonesia', 'Asia', 'Cultural', '/src/assets/dest-borobudur.jpg', 26.99, 40, 4.8, -7.6079, 110.2038, true),
('Bagan Temples', 'Ancient temples and pagodas scattered across Myanmar plains', 'Myanmar', 'Asia', 'Cultural', '/src/assets/dest-bagan-temples.jpg', 28.99, 45, 4.7, 21.1719, 94.8575, true),
('Ha Long Bay', 'UNESCO World Heritage site with limestone karsts in Vietnam', 'Vietnam', 'Asia', 'Nature', '/src/assets/dest-ha-long-bay.jpg', 31.99, 50, 4.7, 20.9101, 107.1839, true),
('Jeju Island', 'Volcanic island with waterfalls and coastal beauty in South Korea', 'South Korea', 'Asia', 'Nature', '/src/assets/dest-jeju-island.jpg', 33.99, 55, 4.6, 33.4996, 126.5312, true),
